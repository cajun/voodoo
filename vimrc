...
autocmd User Rails Rnavcommand javascript app/assets/javascripts -glob=**/* -suffix=
autocmd User Rails Rnavcommand backbone app/assets/javascripts/backbone -glob=**/* -suffix=
